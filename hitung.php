        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              ...
              <table>
                <form action="proses-sma.php" method="post">
                <tr>
          				<td>Kecamatan</td>
          				<td>
					<select class="form-control" type="text" name="kecamatan" id="kecamatan" for="kecamatan"  style="width: 250px">
					<?php
					  	$koneksi=mysqli_connect('localhost','root','');  
  						mysqli_select_db($koneksi,'db_mamdani');
						$sqltxt = "SELECT * FROM data_kecamatan ORDER BY id";
                  ...
                  <td>Tipe Rumah</td>
                  <td>
                    <select class="form-control" type="text" name="tipe" id="tipe" for="tipe">
					<?php for($i=1; $i<=12; $i++){ ?>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Apakah kamu yakin ingin Leave.</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-primary" href="index.php">Leave</a>
        </div>
      </div>
    </div>
  </div>
